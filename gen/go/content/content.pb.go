...
var file_content_content_proto_depIdxs = []int32{
	...
	1,  // 16: content.Content.CreateTopic:input_type -> content.CreateTopicRequest
	3,  // 17: content.Content.GetTopic:input_type -> content.GetTopicRequest
	5,  // 18: content.Content.ListTopics:input_type -> content.ListTopicsRequest
	7,  // 19: content.Content.DeleteTopic:input_type -> content.DeleteTopicRequest
	10, // 20: content.Content.CreatePost:input_type -> content.CreatePostRequest
	12, // 21: content.Content.GetPost:input_type -> content.GetPostRequest
	14, // 22: content.Content.ListPosts:input_type -> content.ListPostsRequest
	16, // 23: content.Content.UpdatePost:input_type -> content.UpdatePostRequest
	18, // 24: content.Content.DeletePost:input_type -> content.DeletePostRequest
	21, // 25: content.Content.CreateComment:input_type -> content.CreateCommentRequest
	23, // 26: content.Content.GetComment:input_type -> content.GetCommentRequest
	25, // 27: content.Content.ListComments:input_type -> content.ListCommentsRequest
	27, // 28: content.Content.UpdateComment:input_type -> content.UpdateCommentRequest
	29, // 29: content.Content.DeleteComment:input_type -> content.DeleteCommentRequest
	2,  // 30: content.Content.CreateTopic:output_type -> content.CreateTopicResponse
	4,  // 31: content.Content.GetTopic:output_type -> content.GetTopicResponse
	6,  // 32: content.Content.ListTopics:output_type -> content.ListTopicsResponse
	8,  // 33: content.Content.DeleteTopic:output_type -> content.DeleteTopicResponse
	11, // 34: content.Content.CreatePost:output_type -> content.CreatePostResponse
	13, // 35: content.Content.GetPost:output_type -> content.GetPostResponse
	15, // 36: content.Content.ListPosts:output_type -> content.ListPostsResponse
	17, // 37: content.Content.UpdatePost:output_type -> content.UpdatePostResponse
	19, // 38: content.Content.DeletePost:output_type -> content.DeletePostResponse
	22, // 39: content.Content.CreateComment:output_type -> content.CreateCommentResponse
	24, // 40: content.Content.GetComment:output_type -> content.GetCommentResponse
	26, // 41: content.Content.ListComments:output_type -> content.ListCommentsResponse
	28, // 42: content.Content.UpdateComment:output_type -> content.UpdateCommentResponse
	30, // 43: content.Content.DeleteComment:output_type -> content.DeleteCommentResponse
