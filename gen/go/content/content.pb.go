...
var file_content_content_proto_depIdxs = []int32{
	23, // 0: content.Topic.created_at:type_name -> google.protobuf.Timestamp
	0,  // 1: content.ListTopicsResponse.topics:type_name -> content.Topic
	23, // 2: content.Post.created_at:type_name -> google.protobuf.Timestamp
	23, // 3: content.Post.updated_at:type_name -> google.protobuf.Timestamp
	7,  // 4: content.ListPostsResponse.posts:type_name -> content.Post
	23, // 5: content.Comment.created_at:type_name -> google.protobuf.Timestamp
	23, // 6: content.Comment.updated_at:type_name -> google.protobuf.Timestamp
	15, // 7: content.ListCommentsResponse.comments:type_name -> content.Comment
	1,  // 8: content.Content.CreateTopic:input_type -> content.CreateTopicRequest
	2,  // 9: content.Content.GetTopic:input_type -> content.GetTopicRequest
	3,  // 10: content.Content.ListTopics:input_type -> content.ListTopicsRequest
	5,  // 11: content.Content.DeleteTopic:input_type -> content.DeleteTopicRequest
	8,  // 12: content.Content.CreatePost:input_type -> content.CreatePostRequest
	9,  // 13: content.Content.GetPost:input_type -> content.GetPostRequest
	10, // 14: content.Content.ListPosts:input_type -> content.ListPostsRequest
	12, // 15: content.Content.UpdatePost:input_type -> content.UpdatePostRequest
	13, // 16: content.Content.DeletePost:input_type -> content.DeletePostRequest
	16, // 17: content.Content.CreateComment:input_type -> content.CreateCommentRequest
	17, // 18: content.Content.GetComment:input_type -> content.GetCommentRequest
	18, // 19: content.Content.ListComments:input_type -> content.ListCommentsRequest
	20, // 20: content.Content.UpdateComment:input_type -> content.UpdateCommentRequest
	21, // 21: content.Content.DeleteComment:input_type -> content.DeleteCommentRequest
	0,  // 22: content.Content.CreateTopic:output_type -> content.Topic
	0,  // 23: content.Content.GetTopic:output_type -> content.Topic
	4,  // 24: content.Content.ListTopics:output_type -> content.ListTopicsResponse
	6,  // 25: content.Content.DeleteTopic:output_type -> content.DeleteTopicResponse
	7,  // 26: content.Content.CreatePost:output_type -> content.Post
	7,  // 27: content.Content.GetPost:output_type -> content.Post
	11, // 28: content.Content.ListPosts:output_type -> content.ListPostsResponse
	7,  // 29: content.Content.UpdatePost:output_type -> content.Post
	14, // 30: content.Content.DeletePost:output_type -> content.DeletePostResponse
	15, // 31: content.Content.CreateComment:output_type -> content.Comment
	15, // 32: content.Content.GetComment:output_type -> content.Comment
	19, // 33: content.Content.ListComments:output_type -> content.ListCommentsResponse
	15, // 34: content.Content.UpdateComment:output_type -> content.Comment
	22, // 35: content.Content.DeleteComment:output_type -> content.DeleteCommentResponse
